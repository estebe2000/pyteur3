...
from app.models import Document, DocumentAssignment, ExerciseAssignment
...
def dashboard():
    ...
    return render_template('eleve_base.html', labels=labels, current_user=current_user, documents=docs, exercises=exs)
